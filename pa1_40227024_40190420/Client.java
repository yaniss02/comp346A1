...
public class Client extends Thread{ 
     ...
     */
     public void receiveTransactions(Transactions transact)
     {
         ...
         while (i < getNumberOfTransactions())
         {     
            //yield if output buffer is empty
           ...
           // System.out.println("\n DEBUG : Client.receiveTransactions() - receiving updated transaction on account " + transact.getAccountNumber());
            ...
            //System.out.println(objNetwork.getOutBufferStatus());
    ...
    public void run(){
    	...
    	long sendingClientStartTime, sendingClientEndTime, receivingClientEndTime, receivingClientStartTime;
    
	    if(getClientOperation().equals("sending")){
            sendingClientStartTime = System.currentTimeMillis();
            sendTransactions();
            sendingClientEndTime = System.currentTimeMillis();
            System.out.println("\n Terminating client sending thread - Running time " +(sendingClientEndTime-sendingClientStartTime +" milliseconds"));
        }
        else if (getClientOperation().equals("receiving")){
            receivingClientStartTime = System.currentTimeMillis();
            receiveTransactions(transact);
            receivingClientEndTime = System.currentTimeMillis();
            System.out.println("\n Terminating client receiving thread - Running time " +(receivingClientEndTime-receivingClientStartTime) +" milliseconds");
